...
//!
//! Note: Device name is auto-generated by the system and can only be retrieved
//! via device.name() after creation.
//!
//! # Example
//! ```
...
//! const dev_name = try device.name(); // Get auto-generated name
...
pub const DeviceBuilder = struct {
    ...
    pub fn createFromFd(fd: std.posix.fd_t, mtu: u16) TunError!Device {
        return Device.createFromFd(fd, null, mtu);
    }
};
